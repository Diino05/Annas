...
<div class="container mt-5">
    ...
    if (isset($_POST['nama'], $_POST['nim'], $_POST['kelas'], $_POST['mata_kuliah'], $_POST['nilai1'], $_POST['nilai2'], $_POST['uts'], $_POST['uas'], $_POST['absen'])) {
        ...
        $total_nilai = ($nilai1 * 0.15) + ($nilai2 * 0.15) + ($uts * 0.20) + ($uas * 0.30) + ($absen * 0.20);
        ...
        echo "Nilai: $total_nilai, dikonversi menjadi Grade: $grade";
        echo "</div>";
    } else {
...
<a href="tugasif.php">Back To Home</a>
